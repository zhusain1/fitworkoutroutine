  ...
  return (
    <div>
      <MainCard>
        ...
        <p>8768 Ruppert Court Ellicott City, MD</p>
        <p>
          <strong>Owner contact email:</strong> info@fitworkoutroutine.com
        </p>
        <h2 id="types_of_data">
        ...
        <p>The Owner may be allowed to retain Personal Data for a longer period whenever the User has given consent to such processing, as long as such consent is not withdrawn. Furthermore, the Owner may be obliged to retain Personal Data for a longer period whenever required to do so for the performance of a legal obligation or upon order of an authority. <br />
          <br />Once the retention period expires, Personal Data shall be deleted. Therefore, the right of access, the right to erasure, the right to rectification and the right to data portability cannot be enforced after expiration of the retention period.
        </p>
        <br />
        ...
        <ul>
          ...
          <br />
          <li>
            <strong>Restrict the processing of their Data.</strong> Users have the right, under certain circumstances, to restrict the processing of their Data. In this case, the Owner will not process their Data for any purpose other than storing it. <br />
          </li>
          <br />
          <li>
        ...
        <h3 className="iub-subheading iub-subheading-legal-how-to-exercise">
          <br /> How to exercise these rights <br />
        </h3>
        ...
        <h3 id="definitions_and_legal_references">
          <br /> Definitions and legal references
        </h3>
